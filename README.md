...
**2、会员变试用，先检查一下飞牛是否开启了防火墙？需要对端口9014、8011、20360~20367允许全部协议出入访问，且保证这些端口不被占用，然后在【应用中心-微备份-停用，再启用】。**
...
使用微备份前，必须打开 **9014、8011、20360 ~ 20367** 这些端口，且保证这些端口不被占用，否则可能导致程序启动异常或无法使用。
...
2、你的飞牛系统限制了我们的端口号，我们用到的端口号有：9014、8011、20360、20361、20362、20363、20364、20365、20366、20367，且保证这些端口不被占用，然后在应用中心-微备份-停用，再启用；
