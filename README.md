...
* 飞牛OS（x86）：**已上线**
* 飞牛OS（arm）：**已上线（[从1.0.7版本开始，微备份支持飞牛arm版，但目前暂未上架到飞牛arm版的应用中心，因此需手动安装。可在Releases中找到微备份arm版的安装包“WxBackup_1.0.X.0_arm.fpk”，然后手动进行安装。👉️点击跳转到Releases](https://github.com/weibeifen/wxbackup/releases)）**
