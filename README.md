...
**2、如遇到“登录时白屏、访问失败、迁移/恢复备份、会员权益”等【常见问题】往下翻即可找到。** 
...
因目前仅支持**飞牛OS（x86）**，故以下的所有使用教程均以 **飞牛OS（x86）、微备份web端** 为例
...
### 为什么使用微备份的升级会失败？为什么没开防火墙和其他限制网络的设置，也无法使用微备份？

目前发现，是使用移动、联通网络的部分用户会出现这些问题，这些问题暂时无法解决。😭😭😭
